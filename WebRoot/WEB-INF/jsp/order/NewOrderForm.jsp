...
<div id="Catalog"><form action="changeShipAddress" method="post">
	...
	<table>
		...
		<tr>
			<td colspan=2><input type="radio" name="shippingAddressRequired" value="1"/>Ship to different address...
			<input type="radio" name="shippingAddressRequired" value="0" checked="checked"/>Not Ship to different address
			</td>
		</tr>
